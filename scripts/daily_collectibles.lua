local daily_collectibles_tab = gui.get_tab("GUI_TAB_LUA_SCRIPTS")

local challenges_tab     = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local hidden_cache_tab   = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local treasure_chest_tab = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local shipwrecked_tab    = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local buried_stash_tab   = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local junk_skydive_tab   = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local time_trials_tab    = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local exotic_exports_tab = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local dead_drop_tab      = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local stash_house_tab    = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local street_dealer_tab  = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local ls_tags_tab        = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
local madrazo_hits_tab   = daily_collectibles_tab:add_tab("GUI_TAB_LUA_SCRIPTS")
...
script.register_looped("Daily Collectibles", function()
    ...
    weekly_obj_str              = HUD.GET_FILENAME_FOR_AUDIO_CONVERSATION((weekly_obj_id < 102 and "AMWO_OBJ_" or "AMWO_OBJ_TX_") .. weekly_obj_id)
