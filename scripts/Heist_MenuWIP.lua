...
LUA:add_sameline()
LUA:add_imgui(function()
	ImGui.Text("                                Heist Menu v1.0 ")
ImGui.Text("                                     1.70 3407")

ImGui.Text("Your level: " .. stats.get_int(MPX() .. "CHAR_RANK_FM"))

ImGui.Text("Your RP Value: " .. stats.get_int(MPX() .. "CHAR_XP_FM"))

ImGui.Text("Current Crew Level: " .. stats.get_int("MPPLY_CURRENT_CREW_RANK"))
...
HeistEditor:add_imgui(function()
	if ImGui.Button("Fix Negative to Positive") then
...
HeistEditor:add_button("No Casino Fees", function()
...
local cayoSizeEditor = HeistEditor:add_tab("Size/Value Editor")
...
MissionsSelectorAndCooldownMenu = LUA:add_tab("Missions Selector And cooldown Menu")
